define(['module', 'exports', 'react', './react_svg', './background', './x_axis', './play_stop', 'underscore'], function (module, exports, _react, _react_svg, _background, _x_axis, _play_stop, _underscore) {
  'use strict';
