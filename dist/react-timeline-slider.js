...
var Background = (function (_React$Component) {
  ...
  _createClass(Background, [{
    key: "render",
    value: function render() {
      return _react2["default"].createElement(_react_svg.Rect, _extends({ width: "100%",
        x: "0", y: "0",
        height: "100%"
      }, this.props.style));
    }
...
},{"./react_svg":5}],3:[function(require,module,exports){
(function (global){
'use strict';
...
var Handler = (function (_React$Component) {
  ...
  _createClass(Handler, [{
    ...
    key: 'render',
    value: function render() {
      return _react2['default'].createElement(_react_svg.Circle, _extends({ cx: this.x,
        cy: '0',
        draggable: true,
...
},{"./react_svg":5,"./tick_collection":8}],4:[function(require,module,exports){
(function (global){
'use strict';
...
var LineBetweenHandlers = (function (_React$Component) {
  ...
  _createClass(LineBetweenHandlers, [{
    key: 'render',
    value: function render() {
      return _react2['default'].createElement(_react_svg.Line, _extends({}, this.props.style, {
        x1: this.props.x1,
        y1: '0',
        x2: this.props.x2,
        y2: '0' }));
...
},{"./react_svg":5}],5:[function(require,module,exports){
(function (global){
'use strict';
...
var Text = (function (_React$Component9) {
  _inherits(Text, _React$Component9);
...
var ReactTimelineSlider = (function (_React$Component) {
  ...
  function ReactTimelineSlider() {
    ...
    _get(Object.getPrototypeOf(ReactTimelineSlider.prototype), 'constructor', this).apply(this, arguments);
  }
...
},{"./auto_width":1,"./timeline_slider":9}],7:[function(require,module,exports){
(function (global){
'use strict';
...
var Tick = (function (_React$Component) {
  ...
  _createClass(Tick, [{
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        _react_svg.G,
        { className: 'tick', transform: 'translate(' + tick.x + ', 0)' },
        _react2['default'].createElement(_react_svg.Circle, _extends({ cx: '0', cy: '0' }, this.props.styles.tickStyle)),
        _react2['default'].createElement(
          'text',
          _extends({ textAnchor: 'middle'
...
},{"./react_svg":5}],8:[function(require,module,exports){
(function (global){
'use strict';
  ...
  _createClass(TickCollection, [{
    ...
    value: function render() {
      ...
      var ticks = this.props.ticks.map(function (t, i) {
        return _react2['default'].createElement(_tick2['default'], { tick: t, key: i, styles: _this.props.styles });
      });
...
},{"./react_svg":5,"./tick":7}],9:[function(require,module,exports){
(function (global){
'use strict';
...
var TimelineSlider = (function (_React$Component) {
  ...
  _createClass(TimelineSlider, [{
    ...
    value: function styles() {
      return _underscore2['default'].extend({}, _styles2['default'], this.props.styles);
    }
  }, {
    key: 'render',
    value: function render() {
      return _react2['default'].createElement(
        _react_svg.SVG,
        { width: this.props.width, height: '40' },
        _react2['default'].createElement(_background2['default'], { style: this.styles().backgroundStyle }),
        _react2['default'].createElement(_x_axis2['default'], { style: this.styles().xAxisStyle,
          styles: this.styles(),
...
},{"./../styles":12,"./background":2,"./react_svg":5,"./x_axis":10,"underscore":15}],10:[function(require,module,exports){
(function (global){
'use strict';
...
var XAxis = (function (_React$Component) {
  ...
  _createClass(XAxis, [{
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        _react_svg.G,
        { className: 'xaxis', transform: 'translate(' + margin + ', ' + margin + ') ' },
        _react2['default'].createElement(_tick_collection2['default'], { ticks: this.ticks(), styles: this.props.styles }),
        (function () {
          if (_this.props.multi) {
            return _react2['default'].createElement(
              ...
              _react2['default'].createElement(_line_between_handlers2['default'], {
                style: _this.props.styles.lineBetweenHandlers,
                x1: _this.getHandlerPosition(_handler.HANDLER_ONE),
                x2: _this.getHandlerPosition(_handler.HANDLER_TWO) }),
              _react2['default'].createElement(_handler2['default'], { ticks: _this.ticks(),
                limits: _this.limits(),

                activeTick: _this.activeTick(_handler.HANDLER_TWO),
                onDrag: _this.setHandlerPosition.bind(_this, _handler.HANDLER_TWO),
                dragged: _this.handlerDragged.bind(_this, _handler.HANDLER_TWO),
                style: _this.props.styles.handlerStyle })
            );
          }
        })(),
...
},{"../tick":13,"./handler":3,"./line_between_handlers":4,"./react_svg":5,"./tick_collection":8}],11:[function(require,module,exports){
(function (global){
"use strict";
...
var _componentsReact_timeline_slider = require("./components/react_timeline_slider");

var _componentsReact_timeline_slider2 = _interopRequireDefault(_componentsReact_timeline_slider);

exports["default"] = _componentsReact_timeline_slider2["default"];

global.ReactTimelineSlider = _componentsReact_timeline_slider2["default"];
module.exports = exports["default"];

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./components/react_timeline_slider":6}],12:[function(require,module,exports){
"use strict";
...
var TickCollection = (function () {
  ...
  _createClass(TickCollection, [{
    ...
    value: function findByValue(v) {
      return this.ticks.find(function (t) {
        return t.value == v;
      });
    }
  }, {
