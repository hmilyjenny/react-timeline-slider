define(['module', 'exports', 'react', './react_svg'], function (module, exports, _react, _react_svg) {
  'use strict';
  ...
  var LineBetweenHandlers = function (_React$Component) {
    ...
    function LineBetweenHandlers() {
      ...
      return _possibleConstructorReturn(this, Object.getPrototypeOf(LineBetweenHandlers).apply(this, arguments));
    }
